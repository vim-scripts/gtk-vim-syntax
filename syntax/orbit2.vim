...
" Options: let orbit2_enable_deprecated = 1
...
syn keyword orbit2Constant ORBIT_DEBUG_ERRORS ORBIT_DEBUG_FORCE_THREADED ORBIT_DEBUG_GIOP ORBIT_DEBUG_INPROC_TRACES ORBIT_DEBUG_MESSAGES ORBIT_DEBUG_NONE ORBIT_DEBUG_OBJECTS ORBIT_DEBUG_REFS ORBIT_DEBUG_TIMINGS ORBIT_DEBUG_TRACES ORBIT_DEBUG_TYPES ORBIT_MEMHOW_FREEFNC ORBIT_MEMHOW_NONE ORBIT_MEMHOW_SIMPLE ORBIT_MEMHOW_TYPECODE
syn keyword orbit2Struct ORBitAsyncQueueEntry ORBitConnection ORBit_IModule
syn keyword orbit2Macro CORBA_sequence_get_release CORBA_sequence_set_release ERRORS GIOP MEMINFO_TO_PTR MESSAGES OBJECTS ORBIT_MEMHOW_ELEMENTS ORBIT_MEMHOW_HOW ORBIT_MEMHOW_MAKE ORBIT_SMALL_FAST_LOCALS ORBIT_SMALL_FORCE_GENERIC_MARSHAL ORBit_sequence_index PTR_TO_MEMINFO TYPES dprintf dump_arg tprintf tprintf_end_method tprintf_header tprintf_timestamp tprintf_trace_value
