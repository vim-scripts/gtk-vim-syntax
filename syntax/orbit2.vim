" Vim syntax file
" Language: C ORBit2 extension (for version 2.10.2)
...
"    let orbit2_enable_deprecated = 1
...
syn keyword orbit2Struct ORBitAsyncQueueEntry ORBitConnection ORBit_IModule
...
if version >= 508 || !exists("did_orbit2_syntax_inits")
  ...
  HiLink orbit2Typedef Type
  HiLink orbit2Constant Constant
  HiLink orbit2Struct Type
  HiLink orbit2Union Type
  HiLink orbit2Macro Macro
  HiLink orbit2Enum Type
  HiLink orbit2UserFunction Type
  HiLink orbit2Define Constant
  if exists("orbit2_deprecated_errors")
    HiLink orbit2DeprecatedFunction Error
    HiLink orbit2DeprecatedTypedef Error
    HiLink orbit2DeprecatedConstant Error
    HiLink orbit2DeprecatedStruct Error
    HiLink orbit2DeprecatedUnion Error
    HiLink orbit2DeprecatedMacro Error
    HiLink orbit2DeprecatedEnum Error
    HiLink orbit2DeprecatedUserFunction Error
    HiLink orbit2DeprecatedDefine Error
  elseif exists("orbit2_enable_deprecated")
    HiLink orbit2DeprecatedFunction Function
    HiLink orbit2DeprecatedTypedef Type
    HiLink orbit2DeprecatedConstant Constant
    HiLink orbit2DeprecatedStruct Type
    HiLink orbit2DeprecatedUnion Type
    HiLink orbit2DeprecatedMacro Macro
    HiLink orbit2DeprecatedEnum Type
    HiLink orbit2DeprecatedUserFunction Type
    HiLink orbit2DeprecatedDefine Constant
  endif
  delcommand HiLink
endif
