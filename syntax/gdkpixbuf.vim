" Vim syntax file
" Language: C gdk-pixbuf extension (for version 2.10.6)
...
syn keyword gdkpixbufStruct GdkPixbuf GdkPixbufAnimation GdkPixbufAnimationClass GdkPixbufAnimationIter GdkPixbufAnimationIterClass GdkPixbufFormat GdkPixbufLoader GdkPixbufLoaderClass GdkPixbufModule GdkPixbufModulePattern GdkPixbufSimpleAnim GdkPixbufSimpleAnimClass GdkPixdata XlibRgbCmap
syn keyword gdkpixbufMacro GDK_IS_PIXBUF GDK_IS_PIXBUF_ANIMATION GDK_IS_PIXBUF_ANIMATION_CLASS GDK_IS_PIXBUF_ANIMATION_ITER GDK_IS_PIXBUF_ANIMATION_ITER_CLASS GDK_IS_PIXBUF_LOADER GDK_IS_PIXBUF_LOADER_CLASS GDK_IS_PIXBUF_SIMPLE_ANIM GDK_IS_PIXBUF_SIMPLE_ANIM_CLASS GDK_PIXBUF GDK_PIXBUF_ANIMATION GDK_PIXBUF_ANIMATION_CLASS GDK_PIXBUF_ANIMATION_GET_CLASS GDK_PIXBUF_ANIMATION_ITER GDK_PIXBUF_ANIMATION_ITER_CLASS GDK_PIXBUF_ANIMATION_ITER_GET_CLASS GDK_PIXBUF_LOADER GDK_PIXBUF_LOADER_CLASS GDK_PIXBUF_LOADER_GET_CLASS GDK_PIXBUF_SIMPLE_ANIM GDK_PIXBUF_SIMPLE_ANIM_CLASS GDK_PIXBUF_SIMPLE_ANIM_GET_CLASS
syn keyword gdkpixbufEnum GdkColorspace GdkInterpType GdkPixbufAlphaMode GdkPixbufError GdkPixbufFormatFlags GdkPixbufRotation GdkPixdataDumpType GdkPixdataType XlibRgbDither
...
syn keyword gdkpixbufDefine GDK_PIXBUF_ERROR GDK_PIXBUF_MAGIC_NUMBER GDK_PIXBUF_MAJOR GDK_PIXBUF_MICRO GDK_PIXBUF_MINOR GDK_PIXBUF_VAR GDK_PIXBUF_VERSION GDK_PIXDATA_HEADER_LENGTH GDK_TYPE_COLORSPACE GDK_TYPE_INTERP_TYPE GDK_TYPE_PIXBUF GDK_TYPE_PIXBUF_ALPHA_MODE GDK_TYPE_PIXBUF_ANIMATION GDK_TYPE_PIXBUF_ANIMATION_ITER GDK_TYPE_PIXBUF_ERROR GDK_TYPE_PIXBUF_LOADER GDK_TYPE_PIXBUF_ROTATION GDK_TYPE_PIXBUF_SIMPLE_ANIM
...
if version >= 508 || !exists("did_gdkpixbuf_syntax_inits")
  ...
  if exists("gdkpixbuf_deprecated_errors")
    ...
    HiLink gdkpixbufDeprecatedTypedef Error
    HiLink gdkpixbufDeprecatedConstant Error
    HiLink gdkpixbufDeprecatedStruct Error
    HiLink gdkpixbufDeprecatedUnion Error
    HiLink gdkpixbufDeprecatedMacro Error
    HiLink gdkpixbufDeprecatedEnum Error
    HiLink gdkpixbufDeprecatedUserFunction Error
    HiLink gdkpixbufDeprecatedDefine Error
  elseif exists("gdkpixbuf_enable_deprecated")
    HiLink gdkpixbufDeprecatedFunction Function
    HiLink gdkpixbufDeprecatedTypedef Type
    HiLink gdkpixbufDeprecatedConstant Constant
    HiLink gdkpixbufDeprecatedStruct Type
    HiLink gdkpixbufDeprecatedUnion Type
    HiLink gdkpixbufDeprecatedMacro Macro
    HiLink gdkpixbufDeprecatedEnum Type
    HiLink gdkpixbufDeprecatedUserFunction Type
    HiLink gdkpixbufDeprecatedDefine Constant
  endif
  delcommand HiLink
endif
