...
syn keyword vteConstant VTE_DEBUG_CURSOR VTE_DEBUG_EVENTS VTE_DEBUG_IO VTE_DEBUG_KEYBOARD VTE_DEBUG_LIFECYCLE VTE_DEBUG_MISC VTE_DEBUG_PARSE VTE_DEBUG_PTY VTE_DEBUG_RING VTE_DEBUG_SELECTION VTE_DEBUG_SIGNALS VTE_DEBUG_SUBSTITUTION VTE_DEBUG_UPDATES
...
syn keyword vteMacro VTE_BG VTE_BG_CLASS VTE_BG_GET_CLASS VTE_CONV_GUNICHAR_TYPE VTE_DRAW_DOUBLE_WIDE_CHARACTERS VTE_DRAW_MAX_LENGTH VTE_DRAW_OPAQUE VTE_DRAW_SINGLE_WIDE_CHARACTERS VTE_IS_BG VTE_IS_BG_CLASS VTE_IS_REAPER VTE_IS_REAPER_CLASS VTE_IS_TERMINAL VTE_IS_TERMINAL_ACCESSIBLE VTE_IS_TERMINAL_ACCESSIBLE_CLASS VTE_IS_TERMINAL_ACCESSIBLE_FACTORY VTE_IS_TERMINAL_ACCESSIBLE_FACTORY_CLASS VTE_IS_TERMINAL_CLASS VTE_IS_TERMINAL_ERASE_BINDING VTE_META_MASK VTE_NUMLOCK_MASK VTE_REAPER VTE_REAPER_CLASS VTE_REAPER_GET_CLASS VTE_TERMINAL VTE_TERMINAL_ACCESSIBLE VTE_TERMINAL_ACCESSIBLE_CLASS VTE_TERMINAL_ACCESSIBLE_FACTORY VTE_TERMINAL_ACCESSIBLE_FACTORY_CLASS VTE_TERMINAL_ACCESSIBLE_FACTORY_GET_CLASS VTE_TERMINAL_ACCESSIBLE_GET_CLASS VTE_TERMINAL_CLASS VTE_TERMINAL_GET_CLASS VTE_TYPE_BG VTE_TYPE_REAPER VTE_TYPE_TERMINAL VTE_TYPE_TERMINAL_ACCESSIBLE VTE_TYPE_TERMINAL_ACCESSIBLE_FACTORY VTE_TYPE_TERMINAL_ERASE_BINDING vte_glyph_all vte_glyph_double_underline
