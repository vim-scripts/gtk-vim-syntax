" Vim syntax file
" Language: C vte extension (for version 0.19.4)
...
syn keyword vteDeprecatedFunction vte_terminal_get_char_ascent vte_terminal_get_char_descent vte_terminal_get_using_xft vte_terminal_match_add vte_terminal_set_cursor_blinks vte_terminal_set_font_from_string_full vte_terminal_set_font_full
syn keyword vteDeprecatedConstant VTE_ANTI_ALIAS_FORCE_DISABLE VTE_ANTI_ALIAS_FORCE_ENABLE VTE_ANTI_ALIAS_USE_DEFAULT
syn keyword vteDeprecatedMacro VTE_IS_TERMINAL_ANTI_ALIAS VTE_IS_TERMINAL_ERASE_BINDING
