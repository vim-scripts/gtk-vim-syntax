...
" Options: let libglade_enable_deprecated = 1
...
if exists("libglade_enable_deprecated")
syn keyword libgladeMacro glade_bonobo_init glade_gnome_init glade_xml_new_from_memory glade_xml_new_with_domain
endif
