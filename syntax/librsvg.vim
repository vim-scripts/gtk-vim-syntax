" Vim syntax file
" Language: C librsvg extension (for version 2.16.1)
...
syn keyword librsvgDefine RSVG_ERROR RSVG_TYPE_ERROR RSVG_TYPE_HANDLE
...
if version >= 508 || !exists("did_librsvg_syntax_inits")
  ...
  HiLink librsvgUnion Type
  HiLink librsvgMacro Macro
  HiLink librsvgEnum Type
  HiLink librsvgUserFunction Type
  HiLink librsvgDefine Constant
  if exists("librsvg_deprecated_errors")
    HiLink librsvgDeprecatedFunction Error
    HiLink librsvgDeprecatedTypedef Error
    HiLink librsvgDeprecatedConstant Error
    HiLink librsvgDeprecatedStruct Error
    HiLink librsvgDeprecatedUnion Error
    HiLink librsvgDeprecatedMacro Error
    HiLink librsvgDeprecatedEnum Error
    HiLink librsvgDeprecatedUserFunction Error
    HiLink librsvgDeprecatedDefine Error
  elseif exists("librsvg_enable_deprecated")
    HiLink librsvgDeprecatedFunction Function
    HiLink librsvgDeprecatedTypedef Type
    HiLink librsvgDeprecatedConstant Constant
    HiLink librsvgDeprecatedStruct Type
    HiLink librsvgDeprecatedUnion Type
    HiLink librsvgDeprecatedMacro Macro
    HiLink librsvgDeprecatedEnum Type
    HiLink librsvgDeprecatedUserFunction Type
    HiLink librsvgDeprecatedDefine Constant
  endif
  delcommand HiLink
endif
