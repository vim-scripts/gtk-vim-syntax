" Vim syntax file
" Language: C libgnome extension (for version 2.16.0)
...
syn keyword libgnomeMacro GNOME_CALL_PARENT GNOME_CALL_PARENT_WITH_DEFAULT GNOME_CLASS_BOILERPLATE GNOME_IS_PROGRAM GNOME_IS_PROGRAM_CLASS GNOME_PROGRAM GNOME_PROGRAM_CLASS GNOME_REGISTER_TYPE gnome_util_home_file gnome_util_prepend_user_home
...
if version >= 508 || !exists("did_libgnome_syntax_inits")
  ...
  if exists("libgnome_deprecated_errors")
    ...
    HiLink libgnomeDeprecatedTypedef Error
    HiLink libgnomeDeprecatedConstant Error
    HiLink libgnomeDeprecatedStruct Error
    HiLink libgnomeDeprecatedUnion Error
    HiLink libgnomeDeprecatedMacro Error
    HiLink libgnomeDeprecatedEnum Error
    HiLink libgnomeDeprecatedUserFunction Error
    HiLink libgnomeDeprecatedDefine Error
  elseif exists("libgnome_enable_deprecated")
    HiLink libgnomeDeprecatedFunction Function
    HiLink libgnomeDeprecatedTypedef Type
    HiLink libgnomeDeprecatedConstant Constant
    HiLink libgnomeDeprecatedStruct Type
    HiLink libgnomeDeprecatedUnion Type
    HiLink libgnomeDeprecatedMacro Macro
    HiLink libgnomeDeprecatedEnum Type
    HiLink libgnomeDeprecatedUserFunction Type
