" Vim syntax file
" Language: C libgnomecanvas extension (for version 2.8.0)
...
"    let libgnomecanvas_enable_deprecated = 1
...
syn keyword libgnomecanvasDefine GNOME_CANVAS_EPSILON GNOME_TYPE_CANVAS GNOME_TYPE_CANVAS_BPATH GNOME_TYPE_CANVAS_CLIPGROUP GNOME_TYPE_CANVAS_ELLIPSE GNOME_TYPE_CANVAS_GROUP GNOME_TYPE_CANVAS_ITEM GNOME_TYPE_CANVAS_LINE GNOME_TYPE_CANVAS_PIXBUF GNOME_TYPE_CANVAS_POINTS GNOME_TYPE_CANVAS_POLYGON GNOME_TYPE_CANVAS_RE GNOME_TYPE_CANVAS_RECT GNOME_TYPE_CANVAS_RICH_TEXT GNOME_TYPE_CANVAS_SHAPE GNOME_TYPE_CANVAS_TEXT GNOME_TYPE_CANVAS_WIDGET
...
if version >= 508 || !exists("did_libgnomecanvas_syntax_inits")
  ...
  HiLink libgnomecanvasTypedef Type
  HiLink libgnomecanvasConstant Constant
  HiLink libgnomecanvasStruct Type
  HiLink libgnomecanvasUnion Type
  HiLink libgnomecanvasMacro Macro
  HiLink libgnomecanvasEnum Type
  HiLink libgnomecanvasUserFunction Type
  HiLink libgnomecanvasDefine Constant
  if exists("libgnomecanvas_deprecated_errors")
    HiLink libgnomecanvasDeprecatedFunction Error
    HiLink libgnomecanvasDeprecatedTypedef Error
    HiLink libgnomecanvasDeprecatedConstant Error
    HiLink libgnomecanvasDeprecatedStruct Error
    HiLink libgnomecanvasDeprecatedUnion Error
    HiLink libgnomecanvasDeprecatedMacro Error
    HiLink libgnomecanvasDeprecatedEnum Error
    HiLink libgnomecanvasDeprecatedUserFunction Error
    HiLink libgnomecanvasDeprecatedDefine Error
  elseif exists("libgnomecanvas_enable_deprecated")
    HiLink libgnomecanvasDeprecatedFunction Function
    HiLink libgnomecanvasDeprecatedTypedef Type
    HiLink libgnomecanvasDeprecatedConstant Constant
    HiLink libgnomecanvasDeprecatedStruct Type
    HiLink libgnomecanvasDeprecatedUnion Type
    HiLink libgnomecanvasDeprecatedMacro Macro
    HiLink libgnomecanvasDeprecatedEnum Type
    HiLink libgnomecanvasDeprecatedUserFunction Type
    HiLink libgnomecanvasDeprecatedDefine Constant
  endif
  delcommand HiLink
endif
