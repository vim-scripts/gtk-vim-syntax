" Vim syntax file
" Language: C gtkglext extension (for version 1.0.6)
...
"    let gtkglext_enable_deprecated = 1
...
if version >= 508 || !exists("did_gtkglext_syntax_inits")
  ...
  HiLink gtkglextTypedef Type
  HiLink gtkglextConstant Constant
  HiLink gtkglextStruct Type
  HiLink gtkglextUnion Type
  HiLink gtkglextMacro Macro
  HiLink gtkglextEnum Type
  HiLink gtkglextUserFunction Type
  HiLink gtkglextDefine Constant
  if exists("gtkglext_deprecated_errors")
    HiLink gtkglextDeprecatedFunction Error
    HiLink gtkglextDeprecatedTypedef Error
    HiLink gtkglextDeprecatedConstant Error
    HiLink gtkglextDeprecatedStruct Error
    HiLink gtkglextDeprecatedUnion Error
    HiLink gtkglextDeprecatedMacro Error
    HiLink gtkglextDeprecatedEnum Error
    HiLink gtkglextDeprecatedUserFunction Error
    HiLink gtkglextDeprecatedDefine Error
  elseif exists("gtkglext_enable_deprecated")
    HiLink gtkglextDeprecatedFunction Function
    HiLink gtkglextDeprecatedTypedef Type
    HiLink gtkglextDeprecatedConstant Constant
    HiLink gtkglextDeprecatedStruct Type
    HiLink gtkglextDeprecatedUnion Type
    HiLink gtkglextDeprecatedMacro Macro
    HiLink gtkglextDeprecatedEnum Type
    HiLink gtkglextDeprecatedUserFunction Type
    HiLink gtkglextDeprecatedDefine Constant
  endif
  delcommand HiLink
endif
